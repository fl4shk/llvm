//===-- SPCPUAsmPrinter.cpp - SPCPU LLVM assembly writer ------------------===//
//
...
// of machine-dependent LLVM code to the XAS-format SPCPU assembly language.
//
//===----------------------------------------------------------------------===//
...
void SPCPUAsmPrinter::EmitFunctionBodyStart() {
}

void SPCPUAsmPrinter::EmitFunctionEntryLabel() {
...
extern "C" void LLVMInitializeSPCPUAsmPrinter() {
  RegisterAsmPrinter<SPCPUAsmPrinter> X(TheSPCPUTarget);
}
